...
//               <div className='mb-0 nter md:mb-0 border-t border-snow-700'>
//                 <a
...
//               <div className='mb-0  border-t border-snow-700'>
//                 <a
//                   className={`flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${
//                     tab !== 2
...
//               </div>
//               {/* Viscosity Builders */}
//               <div className='mb-8 md:mb-0 border-t border-b border-snow-700'>
//                 <a
//                   className={`flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${
//                     tab !== 7
//                       ? ' shadow-md border-transparent hover:shadow-lg rounded'
